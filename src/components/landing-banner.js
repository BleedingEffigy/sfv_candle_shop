...
const Landing = () => (
  <div>
    ...
    <section className="p-20 bg-purple-400">
    	<SEO title="Home" />
    	<div className="hidden sm:grid grid-cols-6 grid-rows-2 gap-8 h-screen">
			...
			<div className='col-start-4 col-span-2 text-center text-white text-3xl mt-4 p-3 nm-pink-flat'>
				<span className="bg-clip-text text-transparent 
                            bg-gradient-to-r from-yellow-100 to-pink-200 filter hover:brightness-125">
					Contact us below!
				</span>
		...
		<div className="sm:hidden flex flex-col">
			...
			<div>
			<Link to="/candles">
				<button className="nm-pink-flat text-white hover:text-gray-300 w-full text-3xl rounded p-2 mt-12 ">
					<span className="bg-clip-text text-transparent 
                            bg-gradient-to-r from-yellow-100 to-pink-200 filter hover:brightness-125">
						Browse
					</span>
			...
			<div>
				<div className='col-start-4 col-span-2 text-center text-white text-3xl mt-8 p-3 nm-pink-flat'>
				<span className="bg-clip-text text-transparent 
                            bg-gradient-to-r from-yellow-100 to-pink-200 filter hover:brightness-125">
					Contact us below!
				</span>
